...
.\scripts\install-msix-bridge.ps1 `
  -PackagePath artifacts\packages\SIGSEGVYandexCalendarNotifier-0.7.0.0-x64.msix `
  -CertificatePath artifacts\packages\SIGSEGVYandexCalendarNotifier-0.7.0.0-x64.cer `
