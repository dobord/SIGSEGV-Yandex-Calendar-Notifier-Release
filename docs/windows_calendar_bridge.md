...
.\scripts\install-msix-bridge.ps1 `
  -PackagePath artifacts\packages\SIGSEGVYandexCalendarBridge-0.6.6.0-x64.msix `
  -CertificatePath artifacts\packages\SIGSEGVYandexCalendarBridge-0.6.6.0-x64.cer `
